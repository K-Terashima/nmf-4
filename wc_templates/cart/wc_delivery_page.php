			...
			<div class="row">
				<div class="col s12">
					...
					<table class="customer_form" id="time">
						...
						<tr>
							<th scope="row"><?php _e('*', 'usces'); ?><?php _e('payment method', 'usces'); ?></th>
					...
					<table class="customer_form" id="notes_table">
						<tr>
							...
							<td colspan="2"><textarea name="offer[note]" id="note" class="materialize-textarea"><?php echo esc_html($entry_order_note); ?></textarea></td>
						</tr>
					</table>

					<div class="send">
						<input name="offer[cus_id]" type="hidden" value="" />
						<input name="backCustomer" type="submit" class="btn-flat" value="<?php _e('Back', 'usces'); ?>"<?php echo apply_filters('usces_filter_deliveryinfo_prebutton', NULL); ?> />
						<input name="confirm" type="submit" class="btn pink accent-1 right" value="<?php _e(' Next ', 'usces'); ?>"<?php echo apply_filters('usces_filter_deliveryinfo_nextbutton', NULL); ?> />
					</div>
